import { dist } from '../vite.config.js';

import * as marchingSquares from (dist.lib('marchingsquares'));

import * as simplify from '../node_modules/simplify-js/simplify.js';

console.log(simplify);

// const marchingSquares = require('marchingsquares');

let api = new Worker('http://192.168.31.195:5173/src/bench_worker.js');
